...
models = {
    "YOLO V11m": YOLO(r"./weight_models/yolo11m_best.pt"), 
    "YOLO V8m": YOLO(r"./weight_models/yolo8m_best.pt"),
    "YOLO V5m": YOLO(r"./weight_models/yolo5m_best.pt"),
}

sahi_models = {
    "SAHI YOLO V11m": AutoDetectionModel.from_pretrained(
        model_type="yolov8",
        model_path=r"./weight_models/yolo11m_best.pt",  
        confidence_threshold=0.5,
        device="cpu"
    ),
    "SAHI YOLO V8m": AutoDetectionModel.from_pretrained(
        model_type="yolov8",
        model_path=r"./weight_models/yolo8m_best.pt",
        confidence_threshold=0.5,
        device="cpu"
    ),
    "SAHI YOLO V5m": AutoDetectionModel.from_pretrained(
        model_type="yolov8",
        model_path=r"./weight_models/yolo5m_best.pt",
        confidence_threshold=0.5,
        device="cpu"
    ),
}
